...
- 상태: **1단계(규범 문서) RESOLVED** — `docs/TASKS.md` T28에서 SPEC §18/DESIGN §12/TESTING §8/TASKS(T0~T7 정정 + T28~T37)를 반영했다(2026-09-03). 2단계(코드+테스트)는 T29~T35, 3단계(운영 문서 동기화)는 T36, 4단계(tarball 재검수)는 T37에서 진행한다 — DOC-001은 이번에 해소, DOC-002~004는 T36에서, DOC-005(001~003 lifecycle)는 이번에 001~003에 상태 표기를 추가해 해소했다.
